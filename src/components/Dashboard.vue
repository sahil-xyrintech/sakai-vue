  ...
  <div class="grid">
    <div class="col-12 lg:col-6 xl:col-3">
      <div class="card mb-0">
        <div class="flex justify-content-between mb-3">
          <div>
            <span class="block text-500 font-medium mb-3">Interview</span>
          ...
          >
            <i class="pi pi-telegram text-blue-500 text-xl"></i>
          </div>
        </div>
    ...
    <div class="col-12 lg:col-6 xl:col-3">
      <div class="card mb-0">
        <div class="flex justify-content-between mb-3">
          <div>
            <span class="block text-500 font-medium mb-3">Working Days</span>
    ...
    <div class="col-12 lg:col-6 xl:col-3">
      <div class="card mb-0">
        ...
        <span class="text-500">newly join</span>
      </div>
    </div>
    <div class="col-12 lg:col-6 xl:col-3">
      <div class="card mb-0">
        <div class="flex justify-content-between mb-3">
          <div>
            <span class="block text-500 font-medium mb-3">Leave Request</span>
            <div class="text-900 font-medium text-xl">5 Unread</div>
          </div>
          <div
    ...
    <div class="col-12 xl:col-6">
      ...
      <div class="card">
        ...
        <ul class="list-none p-0 m-0">
          ...
          >
            <div>
              <span class="text-900 font-medium mr-2 mb-1 md:mb-0">HR</span>
              <div class="mt-1 text-600">HR</div>
            </div>
            <div class="mt-2 md:mt-0 flex align-items-center">
              ...
              <span class="text-orange-500 ml-3 font-medium">%70</span>
            </div>
          </li>
          <li
            class="flex flex-column md:flex-row md:align-items-center md:justify-content-between mb-4"
          >
            <div>
              <span class="text-900 font-medium mr-2 mb-1 md:mb-0">Sahil</span>
              <div class="mt-1 text-600">Web Designer</div>
            </div>
            <div class="mt-2 md:mt-0 ml-0 md:ml-8 flex align-items-center">
              ...
              <span class="text-cyan-500 ml-3 font-medium">%100</span>
            </div>
          </li>
          <li
            class="flex flex-column md:flex-row md:align-items-center md:justify-content-between mb-4"
          >
            <div>
              <span class="text-900 font-medium mr-2 mb-1 md:mb-0"
                >Gursevak Singh</span
              >
              <div class="mt-1 text-600">Laravel Developer</div>
            </div>
            <div class="mt-2 md:mt-0 ml-0 md:ml-8 flex align-items-center">
              <div
                class="surface-300 border-round overflow-hidden w-10rem lg:w-6rem"
          ...
          >
            <div>
              <span class="text-900 font-medium mr-2 mb-1 md:mb-0"
                >Mohit Kumar</span
              >
              <div class="mt-1 text-600">Vue Developer</div>
            </div>
            <div class="mt-2 md:mt-0 ml-0 md:ml-8 flex align-items-center">
              <div
                class="surface-300 border-round overflow-hidden w-10rem lg:w-6rem"
